summon item ~ ~ ~ {Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{display:{Name:'{"text":"空腹の杖","color":"gold","italic":false}',Lore:['{"text":"持っているだけでお腹が減る","color":"aqua","italic":false}','{"text":"右クリックして魔法を発動"}']},HideFlags:3,RepairCost:999,PMwandID:5b,PMshowMP:1b,Enchantments:[{id:"minecraft:mending",lvl:1s}]}}}
