...
execute as @s[scores={PMag_mpregene=80..}] run scoreboard players add @s PMag_MP 1
execute as @s[scores={PMag_mpregene=80..}] run scoreboard players set @s PMag_mpregene 0
