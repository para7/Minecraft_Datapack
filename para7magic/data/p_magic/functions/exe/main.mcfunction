...
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=4,PMag_MP=28..}] run function p_magic:exe/life/magic4
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=4,PMag_MP=28..}] run scoreboard players remove @s PMag_MP 28
...
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=4,PMag_MP=16..}] run function p_magic:exe/structure/magic2
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=4,PMag_MP=16..}] run scoreboard players remove @s PMag_MP 16
