...
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=2,PMag_MP=13..}] run function p_magic:exe/element/magic2
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=2,PMag_MP=13..}] run scoreboard players remove @s PMag_MP 13
...
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=3,PMag_MP=14..}] run function p_magic:exe/life/magic3
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=3,PMag_MP=14..}] run scoreboard players remove @s PMag_MP 14
