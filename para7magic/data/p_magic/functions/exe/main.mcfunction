...
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=3,PMag_MP=15..}] run function p_magic:exe/element/magic3
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=3,PMag_MP=15..}] run scoreboard players remove @s PMag_MP 15

execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=4,PMag_MP=12..}] run function p_magic:exe/element/magic4
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=4,PMag_MP=12..}] run scoreboard players remove @s PMag_MP 12

execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=5,PMag_MP=13..}] run function p_magic:exe/element/magic5
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=5,PMag_MP=13..}] run scoreboard players remove @s PMag_MP 13

# ライフ
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=1,PMag_MP=14..}] run function p_magic:exe/life/magic1
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=1,PMag_MP=14..}] run scoreboard players remove @s PMag_MP 14
...
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=4,PMag_MP=26..}] run function p_magic:exe/life/magic4
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=4,PMag_MP=26..}] run scoreboard players remove @s PMag_MP 26

execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=5,PMag_MP=22..}] run function p_magic:exe/life/magic5
execute if entity @s[scores={PMag_MFaith=2,PMag_MSelect=5,PMag_MP=22..}] run scoreboard players remove @s PMag_MP 22
...
execute if entity @s[scores={PMag_MFaith=3,PMag_MSelect=4,PMag_MP=16..}] run function p_magic:exe/control/magic4
execute if entity @s[scores={PMag_MFaith=3,PMag_MSelect=4,PMag_MP=16..}] run scoreboard players remove @s PMag_MP 16
...
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=4,PMag_MP=10..}] run function p_magic:exe/structure/magic4
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=4,PMag_MP=10..}] run scoreboard players remove @s PMag_MP 10
