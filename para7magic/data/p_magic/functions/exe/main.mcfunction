# エレメント
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=1,PMag_MP=10..}] run function p_magic:exe/element/magic1
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=1,PMag_MP=10..}] run scoreboard players remove @s PMag_MP 10

execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=2,PMag_MP=19..}] run function p_magic:exe/element/magic2
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=2,PMag_MP=19..}] run scoreboard players remove @s PMag_MP 19

execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=3,PMag_MP=18..}] run function p_magic:exe/element/magic3
execute if entity @s[scores={PMag_MFaith=1,PMag_MSelect=3,PMag_MP=18..}] run scoreboard players remove @s PMag_MP 18
...
execute if entity @s[scores={PMag_MFaith=3,PMag_MSelect=3,PMag_MP=14..}] run function p_magic:exe/control/magic3
execute if entity @s[scores={PMag_MFaith=3,PMag_MSelect=3,PMag_MP=14..}] run scoreboard players remove @s PMag_MP 14

# アーキテクチャ
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=1,PMag_MP=5..}] run function p_magic:exe/structure/magic1
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=1,PMag_MP=5..}] run scoreboard players remove @s PMag_MP 5
...
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=3,PMag_MP=8..}] run function p_magic:exe/structure/magic3
execute if entity @s[scores={PMag_MFaith=4,PMag_MSelect=3,PMag_MP=8..}] run scoreboard players remove @s PMag_MP 8

execute if entity @s[scores={PMag_Enable=1}] run effect give @s minecraft:hunger 2 45
