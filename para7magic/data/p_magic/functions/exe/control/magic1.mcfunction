...
execute as @e[distance=..12,type=!#para7_utils:friendmob] run data merge entity @s {Motion:[0.0,1.25,0.0]}

execute as @e[distance=..12,type=!#para7_utils:friendmob] at @s run particle minecraft:cloud ~ ~ ~ 0.5 0.5 0.5 0.2 50 normal
