...
execute as @e[distance=..14,type=#para7_utils:enemymob] run data merge entity @s {Motion:[0.0,1.32,0.0]}

execute as @e[distance=..14,type=#para7_utils:enemymob] at @s run particle minecraft:cloud ~ ~ ~ 0.5 0.5 0.5 0.2 50 normal
