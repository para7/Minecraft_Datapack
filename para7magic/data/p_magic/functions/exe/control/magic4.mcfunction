...
execute as @e[type=#para7_utils:enemymob,nbt={OnGround:0b},distance=..10] run data merge entity @s {Motion:[0.0,-5.5,0.0]}
execute as @e[type=minecraft:bat,nbt={OnGround:0b},distance=..10] run data merge entity @s {Motion:[0.0,-5.5,0.0]}
