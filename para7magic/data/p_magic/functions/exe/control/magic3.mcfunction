...
effect give @a[distance=..2] minecraft:jump_boost 24 9
effect give @a[distance=..2] minecraft:slow_falling 30 10
effect give @a[distance=..2] minecraft:speed 24 0
...
tellraw @a[distance=..2] [{"selector":"@s"},{"text":" は エアライダー を唱えた！"}]
