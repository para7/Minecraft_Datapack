...
execute at @e[distance=0.1..18,type=#para7_utils:friendmob] run particle minecraft:heart ~ ~1 ~ 0.5 0.5 0.5 1 6
effect give @e[distance=0.1..18,type=#para7_utils:friendmob] minecraft:regeneration 4 14
