...
effect give @e[type=#para7_utils:undead,distance=..1.7] minecraft:instant_health 1 4
effect give @e[type=!#para7_utils:undead,distance=..1.7] minecraft:instant_damage 1 4
