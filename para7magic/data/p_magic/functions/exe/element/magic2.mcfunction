...
execute as @e[distance=..16] if entity @s[type=!#para7_utils:undead] if block ~ ~-1 ~ minecraft:ice run effect give @s minecraft:instant_damage 1 1
execute as @e[distance=..16] if entity @s[type=!#para7_utils:undead] if block ~ ~-1 ~ minecraft:packed_ice run effect give @s minecraft:instant_damage 1 2
...
execute as @e[distance=..16] if entity @s[type=#para7_utils:undead] if block ~ ~-1 ~ minecraft:ice run effect give @s minecraft:instant_health 1 1
execute as @e[distance=..16] if entity @s[type=#para7_utils:undead] if block ~ ~-1 ~ minecraft:packed_ice run effect give @s minecraft:instant_health 1 2
