...
execute if entity @s[scores={PJSkillTimer=..0},nbt=!{ActiveEffects:[{Id:13b}]}] unless block ~ ~ ~ water unless block ~ ~1 ~ water run effect give @s minecraft:wither 1 1
...
effect give @s[nbt=!{ActiveEffects:[{Id:13b}]}] minecraft:water_breathing 10 0 true
