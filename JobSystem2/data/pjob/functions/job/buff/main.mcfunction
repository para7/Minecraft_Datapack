execute if entity @s[scores={PJJobInfo=1}] run function pjob:job/buff/knight
execute if entity @s[scores={PJJobInfo=2}] run function pjob:job/buff/hunter
execute if entity @s[scores={PJJobInfo=3}] run function pjob:job/buff/miner
execute if entity @s[scores={PJJobInfo=4}] run function pjob:job/buff/bard
