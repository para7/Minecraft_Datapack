...
title @s[scores={PJJobInfo=3,PJSkillSelect=3}] actionbar [{"text":""},{"text":"炭鉱夫 ","color":"yellow"},{"text":"スキル3:目印設置 "},{"text":"位置測定用の目印を設置する","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
...
title @s[scores={PJJobInfo=4,PJSkillSelect=3}] actionbar [{"text":""},{"text":"吟遊詩人 ","color":"yellow"},{"text":"スキル3:猛進マーチ "},{"text":"周囲の機動力をアップ","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
...
title @s[scores={PJJobInfo=5,PJSkillSelect=2}] actionbar [{"text":""},{"text":"薬師 ","color":"yellow"},{"text":"スキル2:解毒 "},{"text":"周囲の体力&一部異常回復","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
title @s[scores={PJJobInfo=5,PJSkillSelect=3}] actionbar [{"text":""},{"text":"薬師 ","color":"yellow"},{"text":"スキル3:超薬草 "},{"text":"周囲の体力を大きく回復する","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
...
title @s[scores={PJJobInfo=90,PJSkillSelect=1}] actionbar [{"text":""},{"text":"エンド ","color":"yellow"},{"text":"スキル1: ムーブ"},{"text":"向いている方向へ短距離テレポートする","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
title @s[scores={PJJobInfo=90,PJSkillSelect=2}] actionbar [{"text":""},{"text":"エンド ","color":"yellow"},{"text":"スキル2:ジャンプ "},{"text":"最寄りの友好モブの場所へワープ","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
title @s[scores={PJJobInfo=90,PJSkillSelect=3}] actionbar [{"text":""},{"text":"エンド ","color":"yellow"},{"text":"スキル3:スワップ "},{"text":"最寄りの敵対モブと場所を入れ替える","color":"aqua"},{"text":" 発動可能まで:"},{"score":{"name":"@s","objective":"PJSkillRecast"},"color":"red"}]
