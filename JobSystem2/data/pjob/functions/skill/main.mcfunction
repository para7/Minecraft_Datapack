...
execute as @s[scores={PJUseSkillExe=1},scores=!{PJJobInfo=0}] run tellraw @s ["",{"text":"ジョブがありません"}]
execute as @s[scores={PJUseSkillChange=1},scores=!{PJJobInfo=0}] run tellraw @s ["",{"text":"ジョブがありません"}]
