...
effect give @e[type=minecraft:elder_guardian,distance=..20] glowing 30 100 true
...
effect give @e[type=minecraft:elder_guardian,distance=..20] instant_damage 1 3 true
...
scoreboard players set @s PJSkillRecast 440
