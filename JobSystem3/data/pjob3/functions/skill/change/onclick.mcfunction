...
execute if entity @s[scores={PJSSetSlot=2}] run scoreboard players operation @s PJSkillSlot2 = @s PJSSetSkillNum
execute if entity @s[scores={PJSSetSlot=2}] run tellraw @s [{"text":"スキル2にスキルをセットしました。"}]

execute if entity @s[scores={PJSSetSlot=3}] run scoreboard players operation @s PJSkillSlot3 = @s PJSSetSkillNum
